...
const skillGroups = [
  {
    label: "Mobile",
    color: "#4ade80",
    skills: ["React Native", "iOS & Android", "App Store & Play Store", "React Navigation", "NativeBase", "BLE Manager"],
  },
  {
    label: "Frontend",
    color: "#60a5fa",
    skills: ["ReactJS", "Next.js", "TypeScript", "Redux Toolkit", "Zustand", "Micro Frontends", "Webpack MF"],
  },
  {
    label: "Backend",
    color: "#f87171",
    skills: ["NodeJS", "NestJS", "REST APIs", "gRPC", "JWT / OAuth 2.0", "WebSocket"],
  },
  {
    label: "UI / Styling",
    color: "#e879f9",
  ...
  },
  {
    label: "DevOps & Tools",
    color: "#fb923c",
    skills: ["Docker", "Kubernetes", "GitLab CI/CD", "SonarQube", "JIRA", "Confluence"],
  },
  {
    label: "Leadership",
    color: "#c770f0",
    skills: ["Team Leadership", "Project Ownership", "Agile / Scrum", "AI-Augmented Dev"],
  },
];
    ...
    <section>
      <Container fluid className="resume-section" id="resume">
        ...
        <Container className="resume-content">
          ...
          {/* ── Hero Header ── */}
          <Row className="align-items-center justify-content-center" style={{ paddingBottom: "10px" }}>
            <Col md={8} className="d-flex flex-column align-items-center text-center">
              ...
              >
                <strong className="main-name gradient-name">SUSHIL CHOUDHARY</strong>
              </motion.h1>
              <motion.p
                custom={1}
                variants={fadeUp}
            ...
            <Row>
              <Col md={12} className="resume-social">
                <ul className="resume-social-links">
                  {[
                    { href: "https://github.com/sushil-choudhary", icon: <AiFillGithub />, target: true },
                    { href: "https://twitter.com/sushil_chotiya", icon: <AiOutlineTwitter />, target: true },
                    { href: "https://www.linkedin.com/in/sushil-choudhary-0545211b3/", icon: <FaLinkedinIn />, target: true },
                    { href: "https://www.instagram.com/sushil.choudhary4/#", icon: <AiFillInstagram />, target: true },
                    { href: "tel:7340321143", icon: <AiFillPhone />, target: false },
                    { href: "mailto:sushilchoudhary9871@gmail.com", icon: <AiFillMail />, target: false },
                  ].map((s, i) => (
                ...
                <div style={{ marginTop: "16px" }}>
                  ...
                  >
                    <AiOutlineDownload style={{ fontSize: "1.2em" }} /> Download Resume
                  </motion.button>
                </div>
              </Col>
            </Row>
          ...
          >
            <Row className="mt-5">
              <Col md={12}>
                <h3 className="purple resume-section-title">Skills &amp; Tools</h3>
                <Row style={{ gap: "0" }}>
                  {skillGroups.map((group, gi) => (
                    <Col key={gi} xs={12} sm={6} md={4} style={{ marginBottom: "18px" }}>
                      <motion.div
            ...
            <Row className="mt-5">
              <Col md={12}>
                ...
                <div className="company-header">
                  <div>
                    <h4 style={{ color: "#ffffff", margin: 0, fontSize: "1.25em" }}>
                      <strong>Sarvika Technologies</strong>
                    </h4>
                    <p style={{ color: "#aaaaaa", margin: "3px 0 0", fontSize: "0.9em" }}>
                      Jaipur, India
                    </p>
                  </div>
                  ...
                  {[
                    {
                      ...
                      isCurrent: true,
                      points: [
                        "👥 Leading &amp; mentoring a team of 7+ engineers — code reviews, sprint planning, architecture decisions, and delivery.",
                    ...
                    {
                      role: "React Intern",
                      period: "Sep 2020 – Dec 2020 · 3 months",
                      color: "#94a3b8",
                      isCurrent: false,
                      points: [
                    ...
                    >
                      <div className="career-dot" style={{ background: entry.color, boxShadow: `0 0 10px ${entry.color}` }} />
                      <div className="career-content">
                        <div className="career-entry-header">
                          <div style={{ display: "flex", alignItems: "center", gap: "10px", flexWrap: "wrap" }}>
                            <h5 style={{ color: entry.color, margin: 0, fontWeight: "700" }}>
                              {entry.role}
                            </h5>
                            {entry.isCurrent && (
          ...
          >
            <Row className="mt-5">
              <Col md={12}>
                <h3 className="purple resume-section-title">Projects Overview</h3>
                ...
                {[
                  {
                    icon: "🎓", title: "Student Information System (SIS)", color: "#4ade80", rgb: "74,222,128",
                    role: "Led Independently", roleColor: "#a855f7", roleBg: "rgba(168,85,247,0.15)",
                    ...
                    tech: ["React 18", "TypeScript", "Redux", "MUI", "Tailwind", "Webpack MFE", "Docker", "K8s"],
                  },
                  {
                    icon: "📚", title: "Learning Management System (LMS)", color: "#60a5fa", rgb: "96,165,250",
                    role: "Led Independently", roleColor: "#a855f7", roleBg: "rgba(168,85,247,0.15)",
                    ...
                    tech: ["React 18", "TypeScript", "Redux", "MUI v7", "Webpack MFE", "WebSocket", "CKEditor 5", "K8s"],
                  },
                  {
                    icon: "🏥", title: "Healthcare Remote Monitoring (RPM)", color: "#f87171", rgb: "248,113,113",
                    role: "Led Independently", roleColor: "#a855f7", roleBg: "rgba(168,85,247,0.15)",
                    ...
                    tech: ["React 18", "React Native", "Redux", "MUI", "Recharts", "BLE Manager", "Firebase", "iOS", "Android"],
                  },
                  {
                    icon: "⚙️", title: "Enterprise Workflow Platform", color: "#fb923c", rgb: "251,146,60",
                    role: "Team Contribution", roleColor: "#f59e0b", roleBg: "rgba(245,158,11,0.15)",
                    ...
                    tech: ["React", "Redux", "MUI v4/v5", "Webpack MFE", "Formik", "Kubernetes"],
                  },
                  {
                    icon: "👨‍🏫", title: "Online Tutoring Platform", color: "#e879f9", rgb: "232,121,249",
                    role: "Team Contribution", roleColor: "#f59e0b", roleBg: "rgba(245,158,11,0.15)",
                    ...
                    tech: ["React 16", "Redux", "Socket.IO", "Material UI", "Recharts", "Docker", "Kubernetes"],
                  },
                ].map((item, i) => (
                  <motion.div
                    key={i}
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "8px", flexWrap: "wrap" }}>
                      ...
                      <h5 style={{ color: item.color, margin: 0 }}>{item.title}</h5>
                      <span style={{ background: item.roleBg, color: item.roleColor, padding: "2px 10px", borderRadius: "20px", fontSize: "0.75em" }}>
                        {item.role}
                      </span>
                    </div>
                    <p style={{ color: "#aaaaaa", marginBottom: "8px", fontSize: "0.9em" }}>{item.desc}</p>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: "6px" }}>
                      {item.tech.map((t) => (
                        <span
                          key={t}
              ...
              <Col md={12}>
                ...
                {[
                  ...
                  <motion.div
                    ...
                    style={item.highlight ? { borderLeft: "3px solid #c770f0", background: "rgba(199,112,240,0.05)" } : {}}
                  >
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "8px" }}>
                      <div style={{ flex: 1 }}>
                        <h5 style={{ color: "#ffffff", margin: 0 }}>
                          ...
                          {item.highlight && (
                            <span style={{ marginLeft: "10px", background: "rgba(199,112,240,0.15)", color: "#c770f0", padding: "2px 10px", borderRadius: "20px", fontSize: "0.65em", fontWeight: "600", verticalAlign: "middle" }}>
                              Non-Traditional Path ✨
                            </span>
                          )}
                        </h5>
                        <p style={{ color: "#bbbbbb", marginTop: "5px", marginBottom: item.note ? "10px" : 0 }}>{item.school}</p>
                        {item.note && (
                          <p style={{ color: "#888888", fontSize: "0.88em", fontStyle: "italic", margin: 0, lineHeight: "1.6" }}>
                            "{item.note}"
                          </p>
                        )}
                      </div>
